...
public class PersistenciaCafe extends PersistenciaCentral{
	...
	public static void descargarCafe(String reservasArchivo, String historialPrestamosArchivo,String sugerenciasPendientesArchivo,
			String transaccionesArchivo, String mesasArchivo, String  turnosArchivo, Cafe miCafe) 
					...
					JSONException, InvalidCredentialsException, ProductosException, UsuariosException{
	...
	public static void descargarTransaccion(String transaccionesArchivo, Cafe miCafe) throws IOException,
	FileNotFoundException, JSONException, InvalidCredentialsException, ProductosException, UsuariosException {
	...
	public static void descargarHistorialPrestamos(String historialPrestamosArchivo, Cafe miCafe) 
